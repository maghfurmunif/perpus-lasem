...
export const AppSidebar = ({ userName, onLogout }: Props) => {
 ...
 <NavLink to={base} end className="flex gap-3 items-center font-bold text-[#1E4D3E]"><img src="/logo-terang-literasi-transparent.png" alt="Terang Literasi" className="h-12 w-32 object-contain"/></NavLink>
