...
function Cover({ book }: { book: Book }) {
  const [src, setSrc] = useState(book.coverImage || '/logo-lasem-mark.png');
  return <img src={src} onError={() => setSrc('/logo-lasem-mark.png')} alt={book.title} loading="lazy" decoding="async" className="h-64 w-full rounded-2xl object-cover bg-[#F4EFEA]" />;
}
